...
Core/Src/Eeprom/%.o Core/Src/Eeprom/%.su: ../Core/Src/Eeprom/%.c Core/Src/Eeprom/subdir.mk
...
clean-Core-2f-Src-2f-Eeprom:
	-$(RM) ./Core/Src/Eeprom/eeprom.d ./Core/Src/Eeprom/eeprom.o ./Core/Src/Eeprom/eeprom.su
